...
import 'notification_job_detail_view_model.dart';

class NotificationJobDetailView extends StatelessWidget {
  const NotificationJobDetailView({
    super.key,
    ...
    return ViewModelBuilder<NotificationJobDetailViewModel>.reactive(
        ...
        builder: (context, model, _) {
          ...
          return Scaffold(
            ...
            body: model.busy(GET_INSTANT_JOB)
                              ...
                              children: [
                                ...
                                Text(
                                  instantJob?.createdAt == null
                                      ? ""
                                      : humanizeDate(fromIsoToDateTime(
                                          instantJob!.createdAt!)),
